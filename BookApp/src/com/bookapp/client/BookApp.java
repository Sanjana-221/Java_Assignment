...
public class BookApp {
	public static <IBookService> void main(String[] args) {
		...
		try (Scanner scanner = new Scanner(System.in);)
			...
			while(true) {	
				...
				switch(mainMenu) {
				case "1": List<Book> books = ((BookServiceImpl) bookService).getAll(); System.out.println("\nBooks in the Library"); for(Book book : books) System.out.println(book); break;
				case "2": 
					...
					scanner.nextLine();
					((BookServiceImpl) bookService).addBook(new Book(title,author,category,bookId,price));
					break;
				case "3": 
					...
					case "1":	System.out.println("Enter the author: "); author=scanner.nextLine(); try {
							((BookServiceImpl) bookService).getByAuthorContains(author).forEach(System.out::println);;
						} catch (BookNotFoundException e) {
							System.out.println(e.getMessage());
						}
						break;
					case "2":	System.out.println("Enter the category: "); category=scanner.nextLine(); try {
							((BookServiceImpl) bookService).getByCategory(category).forEach(System.out::println);
						} catch (BookNotFoundException e) {
							System.out.println(e.getMessage());
						}
						break;
					case "3":	System.out.println("enter author: "); author=scanner.nextLine(); 
						...
						try {
							((BookServiceImpl) bookService).getByAuthorContainsAndCategory(author, category).forEach(System.out::println);;
						} catch (BookNotFoundException e) {
							System.out.println(e.getMessage());
						}
						break;
					case "4":	System.out.println("enter the Id: "); bookId = scanner.nextInt(); try {
							System.out.println(((BookServiceImpl) bookService).getById(bookId));
						} catch (BookNotFoundException e) {
							System.out.println(e.getMessage());
						}
						break;
					case "5":	System.out.println("enter the price: "); price = scanner.nextDouble(); try {
							((BookServiceImpl) bookService).getByPriceLessThan(price).forEach(System.out::println);;
						} catch (BookNotFoundException e) {
							System.out.println(e.getMessage());
						}
						break;
